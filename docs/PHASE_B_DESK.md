...
Paper JSON body (minimal): market, side, p_true, optional source, bankroll, edge, id, gate_stats, odds_b, fee_rate, slippage_bps, kelly_fraction, open_exposure, mode (dry_run or paper only).
