"""
CSS theme, Mini Mode density overrides, and sidebar toggle JS.
...
def inject_css_and_navbar():
    """Inject the full CSS theme + sticky nav + sidebar toggle. Call ONCE from app.py after set_page_config."""
